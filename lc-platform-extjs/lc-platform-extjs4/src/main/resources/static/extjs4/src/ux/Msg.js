Ext.define('Ext.ux.Msg', {
    ...
    createBox:function(title,s){
    	return '<div style="position: absolute;background: ef8f00;opacity: 0;z-index: 99999;height:24px;text-align: center;"><span style="color:#FFF;background:#68af02;heigth:24px;line-height:24px;border-radius:3px;padding: 3px 24px 3px;">'+s+'</span></div>';
    },
    createBoxError:function(title,s){
    	return '<div style="position: absolute;background: red;opacity: 0;z-index: 99999;height:24px;text-align: center;"><span style="color:#FFF;background:red;heigth:24px;line-height:24px;border-radius:3px;padding: 3px 24px 3px;">'+s+'</span></div>';
    },
    show:function(msg){
